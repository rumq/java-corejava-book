...
public class Constants {
    ...
    public static final String REGX_SPLIT_WORDS = "\\PL+";
    ...
    public static final String BRITISH_POUND = DATA_DIRECTORY + "british_pound.txt" ;    // £ U+00A3 | hex-UTF8 A3       | decimal 163         | hex-UTF16 A3 decimal 163
    public static final String INDIAN_RUPEE = DATA_DIRECTORY + "indian_rupee.txt";       // ₹ U+20B9 | hex-UTF8 E2 82 B9 | decimal 226 130 185 | hex-UTF16 20B9 decimal 8353
    public static final String WON = DATA_DIRECTORY + "won.txt" ;                        // ₩ U+20A9 | hex-UTF8 E2 82 A9 | decimal 226 130 169 | hex-UTF16 20A9 decimal 8361
    public static final String CHARACTER_a = DATA_DIRECTORY + "character_a.txt" ;        // a U+0061 | hex-UTF8 61       | decimal 97          | hex-UTF16 0061 decimal 97
    public static final String CHARACTER_A = DATA_DIRECTORY + "character_A.txt" ;        // A U+0041 | hex-UTF8 41       | decimal 65          | hex-UTF16 0041 decimal 65
